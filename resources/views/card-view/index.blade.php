                            ...
                            <div class="flex gap-2 flex-wrap">
                                @foreach($product->sizes as $size)
                                    <label class="cursor-pointer">
                                        ...
                                        <span class="inline-block border border-gray-300 text-sm px-3 py-1.5 rounded-lg hover:border-gray-900 transition-colors has-[:checked]:bg-gray-900 has-[:checked]:text-white has-[:checked]:border-gray-900">
                                            {{ $size }}
                                        </span>
                                    </label>
                                @endforeach
                            ...
                            <div class="flex gap-2 flex-wrap">
                                @foreach($product->colors as $color)
                                    <label class="cursor-pointer">
                                        ...
                                        <span class="inline-block border border-gray-300 text-sm px-3 py-1.5 rounded-lg hover:border-gray-900 transition-colors has-[:checked]:bg-gray-900 has-[:checked]:text-white">
                                            {{ $color }}
                                        </span>
                                    </label>
                                @endforeach
